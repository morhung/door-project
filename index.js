...
esp8266_nsp.use(middleware); //esp8266 emit sự kiện gì là bắt hết.
...
esp8266_nsp.on('connection', function(socket) {
	...
	//khi nhận được dữ liệu từ arduino gửi lên
	socket.on("*", function(packet) {
		console.log("esp8266 gui data toi client: ", packet.data) //in ra để debug
		var eventName = packet.data[0]
    //nếu gửi thêm json thì lấy json từ lệnh gửi, không thì gửi chuỗi json rỗng, {}
    ...
    // gửi toàn bộ lệnh + json đến app android.
    androidapp_nsp.emit(eventName, eventJson)
	})
})
